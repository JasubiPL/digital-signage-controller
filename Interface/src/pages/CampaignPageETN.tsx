  ...
  return(
    <section className="w-full  h-full flex flex-col items-center overflow-y-auto my-8">
      ...
      <section className="w-[90%] flex justify-between mb-4">
        ...
        <img className="h-12" src="/img/brands/etn-turistar-logo.png" alt="ETN Logo" />
        {
          ...
          allCampaign.map( campaign =>(
            <div key={campaign.id} className="text-center grid grid-cols-5 border-b-[1px] border-gray-200 py-2">
              ...
              <div className="flex gap-4 justify-center">
                <button onClick={() => setModal(<CampaignsBoxOffice campaign={campaign.nombre} modal={setModal} company="ETN" />)} className="hover:scale-110 active:scale-90 transition-all hover:after:content-['Taquillas'] 
                ...
                
                {
                  ...
                  currentPath.pathname.includes('admin') || currentPath.pathname.includes('designers') 
